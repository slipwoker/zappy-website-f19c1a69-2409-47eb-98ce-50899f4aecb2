  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength') && value !== '') {
        ...
        if (value.length < min) {
          showError(field, `يجب أن يحتوي على ${min} أحرف على الأقل`);
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f19c1a69-2409-47eb-98ce-50899f4aecb2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f19c1a69-2409-47eb-98ce-50899f4aecb2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f19c1a69-2409-47eb-98ce-50899f4aecb2';
